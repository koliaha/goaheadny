            ...
            boxList: [
                {
                    ...
                    mail: '*Твой Тайный Санта оформит тебе подписку в течение 5 рабочих дней.',
                    left: true
                }, {
                    class: 'second',
                    num: 2,
                    title: 'Spotify',
                    subtitle: 'Подписка на 12 месяцев',
                    mail: '*Этот подарок доступен, если у тебя уже скачано приложение Spotify. Твой Тайный Санта оформит подписку в течение 5 рабочих дней.', left: false
                }, {
                    class: 'third',
                    num: 3,
                    title: 'ЛитРес',
                    subtitle: 'Электронный подарочный сертификат на лучшие книги',
                    mail: '*Сертификат придёт тебе на почту в течение 5 рабочих дней.', left: true
                }, {
                    class: 'forth',
                    num: 4,
                    title: 'Ляг.Спиной',
                    subtitle: 'Сертификат на 1 сеанс массажа классика/спорт/релакс/лицо',
                    mail: '*Сертификат придёт тебе на почту в течение 5 рабочих дней. Сертификат действует 2 месяца.', left: true
                }, {
                    class: 'fifth',
                    num: 5,
                    title: 'Менталитет',
                    ...
                    mail: '*Cсылка для активации подписки придёт тебе на почту в течение 5 рабочих дней.', left: false
                },
            ],
            curdata: {
                class: 'first',
